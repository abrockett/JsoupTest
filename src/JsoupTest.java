...
public class JsoupTest {
	...
	private static void test(String input) {
        System.out.println("Original   : " + input + 
        		"\nJsoup.clean: " + Jsoup.clean(input, "http://bogus-baseuri.rallydev.com", rallyWhitelist, outputSettings) + 
        		"\naltClean   : " + multiAltClean(input) +
        		"\naltClean2  : " + multiAltClean2(input) +
        		"\n------");   
	}
...
//		return doc.body().html();
		...
		//does not work
//		String output = Jsoup.clean(input, "http://bogus-baseuri.rallydev.com", rallyWhitelist, outputSettings);
